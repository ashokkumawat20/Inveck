...
public class TakeSignOffOfLineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_take_sign_off_of_line);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TakeSignOffOfLineActivity.this, TakeSignOffOfLinePersonDetailActivity.class);
        ...
        TakeSignOffOfLinePersonDetailActivity.bindListener(new Listener() {
            @Override
    ...
    public void addTextListener() {
        ...
        search.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence query, int start, int before, int count) {
                ...
                mList.setLayoutManager(new LinearLayoutManager(TakeSignOffOfLineActivity.this));
                signOffListAdpter = new SignOffListAdpter(TakeSignOffOfLineActivity.this, filteredList);
    ...
    private class getTakeSignList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(TakeSignOffOfLineActivity.this);
        ...
        protected Void doInBackground(Void... params) {
            ...
            data.clear();
            data.addAll(databaseQueryClass.getTakeOffSignPersion());
        ...
        protected void onPostExecute(Void args) {
            ...
            if (data.size() > 0) {
                signOffListAdpter = new SignOffListAdpter(TakeSignOffOfLineActivity.this, data);
                mList.setAdapter(signOffListAdpter);
                mList.setLayoutManager(new LinearLayoutManager(TakeSignOffOfLineActivity.this));
