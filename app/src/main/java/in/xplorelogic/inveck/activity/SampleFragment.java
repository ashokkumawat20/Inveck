...
import in.xplorelogic.inveck.adapter.StockListAdpter1;
...
public class SampleFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (item.getTitle().equals("All")) {
                            adapter = new SampleRecyclerAdapter(getActivity(), data);
                            ...
                            final List<Sample> filteredList = new ArrayList<Sample>();
                            if (data != null) {
                                if (data.size() > 0) {
                            ...
                            adapter = new SampleRecyclerAdapter(getActivity(), filteredList);
                            mList.setLayoutManager(new LinearLayoutManager(getActivity()));
                            mList.setAdapter(adapter);
                            adapter.notifyDataSetChanged();  // data set changed
        ...
        adapter = new SampleRecyclerAdapter(getActivity(), new ArrayList<>());
        mList.setAdapter(adapter);
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                data = jsonHelper.parseSampleList(stockListResponse);
