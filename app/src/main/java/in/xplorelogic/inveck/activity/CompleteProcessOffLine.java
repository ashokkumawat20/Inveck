...
public class CompleteProcessOffLine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complete_process_off_line);
        ...
        data = new ArrayList<>();
        data.clear();
        data.addAll(databaseQueryClass.getAllPending(preferences.getInt("milestone_Id", 0)));
        if(data.size()==0)
        {
        ...
        Continue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
          /*      AlertDialog.Builder builder = new AlertDialog.Builder(CompleteProcessOffLine.this);
                builder.setMessage("Do you want to Continue ?")
                        .setCancelable(false)
                        .setPositiveButton("Continue", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                dialog.cancel();
                                Intent intent = new Intent(CompleteProcessOffLine.this, ExShortProcessOffLine.class);
